...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($umidResult->num_rows > 0) {
        ...
        if ($conn->query($updateStudentQuery) === TRUE) {
            echo "<script>alert('Record updated successfully!'); window.location.href = 'http://ec2-18-222-181-123.us-east-2.compute.amazonaws.com/';</script>";
        } else {
            echo "<script>alert('Error updating student data'); window.location.href = 'http://ec2-18-222-181-123.us-east-2.compute.amazonaws.com/';</script>";
        }
    } else {
