...
<head>
    ...
    <style>
        body {
            ...
            background-image: url('register.jpeg'); /* Replace 'path/to/your/image.jpg' with the actual path to your background image file */
...
<input type="text" id="umid" name="umid" required pattern="[0-9]{8}" placeholder="8 Digit UMID Number" maxlength="8">
